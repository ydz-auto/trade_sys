"""
Low-level pipeline replay data primitives. High-level replay orchestration belongs in runtimes.replay_runtime.
...
State management and orchestration (replay_single_event, register_stage_handler, etc.) belong in runtimes.replay_runtime.
"""
