...
from infrastructure.storage.data_lake.path_utils import get_features_path, get_research_path
...
class StrategyDiscoveryEngine:
    ...
    def load_market_data(self, symbol: str = "BTCUSDT") -> pd.DataFrame:
        ...
        self.current_feature_matrix = fm
    ...
    def scan_features(self, df: pd.DataFrame, target_feature: str = "future_ret_1h") -> List[Dict]:
        ...
        for feature in features_to_scan[:50]:
