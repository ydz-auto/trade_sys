...
from engines.execution.order_manager import OrderManager
# TODO: migrate to new runtime architecture - FillSyncManager moved from runtime.execution_runtime.fill_sync
# from runtime.execution_runtime.fill_sync import FillSyncManager
from infrastructure.persistence.repository.execution.orm_order_repository import ORMOrderRepository
# TODO: migrate to new runtime architecture - OrderPublisher moved from runtime.execution_runtime.publishers.order_publisher
...
class ExecutionEngine:
    ...
    def __init__(
        ...
        self._fill_sync = None  # TODO: migrate FillSyncManager from runtime.execution_runtime.fill_sync

        self._db_manager = db_manager
        self._order_repo: Optional[ORMOrderRepository] = None

        self._order_publisher = None  # TODO: migrate OrderPublisher from runtime.execution_runtime.publishers.order_publisher
    ...
    async def connect_all(self) -> Dict[Exchange, bool]:
        ...
        if any(results.values()) and self._fill_sync:
