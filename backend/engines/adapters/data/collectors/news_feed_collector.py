...
from infrastructure.utilities.resilience.fallback import FallbackChain, PrimaryFallback, StaticValueFallback, create_default_chain

# 导入中文源配置
try:
    from application.config.defaults.business.news_sources import RSS_NEWS_SOURCES
    HAVE_CONFIG = True
except ImportError:
    HAVE_CONFIG = False
    RSS_NEWS_SOURCES = {}
