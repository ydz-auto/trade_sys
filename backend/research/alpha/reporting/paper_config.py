...
from research.alpha.validation.pipeline import AlphaPipelineResult, AlphaValidationResult
...
def main():
    ...
    from research.alpha.validation.pipeline import AlphaPipelineResult

    results = []
    for r_dict in lb_data.get("results", []):
        stages = []
        for s_dict in r_dict.get("stages", []):
            from research.alpha.validation.pipeline import StageResult
        ...
        from research.alpha.validation.pipeline import AlphaValidationResult
