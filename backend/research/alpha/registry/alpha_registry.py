...
AlphaRegistry.register(AlphaDefinition(
    ...
    mode="oi_crowding",
    direction="both",
    primary_feature="oi_zscore",
    signal_direction_map={
        "oi_zscore": "positive_means_short",
        "funding_zscore": "positive_means_short",
    },
    combo_logic="all_must_trigger",
))
...
AlphaRegistry.register(AlphaDefinition(
    ...
    mode="crowding_short",
    direction="short",
    primary_feature="leverage_crowdedness",
    signal_direction_map={
        "leverage_crowdedness": "positive_means_short",
    },
))

AlphaRegistry.register(AlphaDefinition(
    name="oi_funding_divergence_long",
    features=["oi_funding_divergence"],
    mode="divergence_long",
    direction="long",
    primary_feature="oi_funding_divergence",
    signal_direction_map={
        "oi_funding_divergence": "negative_means_long",
    },
))
