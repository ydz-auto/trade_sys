...
from application.workflows.orchestrator.dependency_graph import get_dependency_graph
from application.workflows.lifecycle.runtime_health import get_health_system, HealthStatus
from application.workflows.lifecycle.state_machine import get_state_machine, RuntimeState as LifecycleState
from infrastructure.logging import get_logger
from infrastructure.utilities.runtime_clock import now_ms

_runtime_state_store: Dict[str, Any] = {}


def get_runtime_state_store() -> Dict[str, Any]:
