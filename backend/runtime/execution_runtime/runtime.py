...
class ExecutionRuntime(BaseRuntime):
    ...
    async def initialize(self) -> None:
        ...
        try:
            from runtime.execution_runtime.state_machine.order_state_machine import (
                OrderStateMachine,
                OrderJournal,
                IdempotencyManager,
                RetryEngine,
        ...
        try:
            from runtime.execution_runtime.engine.execution_engine import ExecutionEngine
    ...
    async def transition_order(self, order_id: str, new_status: str, event: str, data: Optional[Dict[str, Any]] = None) -> Optional[Any]:
        ...
        from runtime.execution_runtime.state_machine.order_state_machine import OrderEvent
