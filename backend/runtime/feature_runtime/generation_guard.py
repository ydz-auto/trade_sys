...
logger = get_logger("feature.generation_guard")
...
class FeatureGenerationContext:
    ...
    def __init__(
        ...
        from runtime.replay_runtime.shared_replay.feature_availability_guard import FeatureAvailabilityGuard, get_feature_availability_guard
    ...
    def add_feature(
        ...
        if check_availability:
            from runtime.replay_runtime.shared_replay.feature_availability_guard import FeatureAvailabilityStatus
...
def with_feature_guard(
    ...
    def decorator(func: Callable) -> Callable:
        ...
        def wrapper(*args, **kwargs):
            from runtime.replay_runtime.shared_replay.feature_availability_guard import FeatureAvailabilityStatus, get_feature_availability_guard
