...
用法：
    # 命令行
    python -m runtime.ingestion_runtime.download_service download --exchange binance --symbol BTCUSDT --type klines
    
    # 代码
    from runtime.ingestion_runtime.download_service import DataDownloadService
...
class DownloadConfig:
    ...
    binance_api: str = "https://fapi.binance.com"
...
class DataDownloadService:
    ...
    async def download_klines(
        ...
        end_ts = self._parse_time(end_time) if end_time else int(datetime.now().timestamp() * 1000)
