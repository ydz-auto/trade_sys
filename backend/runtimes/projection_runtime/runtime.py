...
from infrastructure.utilities.runtime_clock import get_clock, ClockMode, now_ms
from domain.feature.availability import get_systematic_guard
from domain.feature.label_isolation import get_label_store
from domain.event.infrastructure.event_ordering import EventOrderingDeterminism
from domain.event.infrastructure.unified_schema import UnifiedEvent
...
class ProjectionRuntime(BaseRuntime):
    ...
    async def initialize(self) -> None:
        ...
        try:
            ...
            from runtime.adapters.config_adapter import get_redis_url
        ...
        try:
            from runtimes.projection_runtime.projections import (
                DashboardProjection,
                DecisionProjection,
                RiskProjection,
                PositionProjection,
