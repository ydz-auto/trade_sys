...
from domain.execution.models.execution_models import ExecutionPosition

logger = logging.getLogger("infrastructure.persistence.repository.execution.orm_position")
