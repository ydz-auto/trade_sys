...
from infrastructure.security.api_gateway.config import PERMISSIONS
from infrastructure.security.api_gateway.exceptions import (
    AuthError,
...
class PermissionChecker:
    ...
    def has_permission(
        ...
        for perm in role_permissions:
            perm_pattern = re.escape(perm).replace("\\*", ".*")

            if re.fullmatch(perm_pattern, permission):
                return True
