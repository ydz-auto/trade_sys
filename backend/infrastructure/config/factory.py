...
使用方式:
    from infrastructure.config.factory import get_infra_config, get_runtime_config
...
from infrastructure.config.startup.settings import (
    StartupSettings,
...
from infrastructure.config.versioning import (
    ConfigVersioning,
    ConfigSnapshot,
...
class ConfigFactory:
    ...
    def register_domain_config(cls, registry=None):
        ...
        for domain_name in domain_registry.get_all_domains():
            ...
            schema = domain_registry.get_schema(domain_name)
