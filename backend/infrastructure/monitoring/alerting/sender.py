...
from infrastructure.monitoring.alerting.config import AlertSeverity, ALERT_SEVERITY_CONFIG
...
class AlertManager:
    ...
    async def create_alert(
        ...
        await self.alert_sender.send(severity, message, name, category, context)
...
async def send_alert(
    ...
    await get_alert_sender().send(severity, message, context=context)
