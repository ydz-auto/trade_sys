...
logger = get_logger("infrastructure.runtime.circuit_breaker")
...
DEFAULT_CIRCUIT_CONFIGS = {
    "ai_runtime": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_AI_RUNTIME_RECOVERY_MS", "60000")),
    ...
    "exchange_api": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_EXCHANGE_API_RECOVERY_MS", "10000")),
    ...
    "websocket_push": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_WEBSOCKET_PUSH_RECOVERY_MS", "5000")),
    ...
    "database": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_DATABASE_RECOVERY_MS", "30000")),
    ...
    "cache": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_CACHE_RECOVERY_MS", "10000")),
    ...
    "kafka": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_KAFKA_RECOVERY_MS", "15000")),
    ...
    "redis": CircuitBreakerConfig(
        ...
        recovery_timeout_ms=int(os.environ.get("CB_REDIS_RECOVERY_MS", "10000")),
