...
from infrastructure.priority_queue import EventPriority

logger = get_logger("infrastructure.runtime.degradation")
...
class DegradationController:
    def __init__(
        ...
        self._thresholds = {
            "cpu_critical": int(os.environ.get("DEG_CPU_CRITICAL", "90")),
            "cpu_safe": int(os.environ.get("DEG_CPU_SAFE", "80")),
            "cpu_degraded": int(os.environ.get("DEG_CPU_DEGRADED", "70")),
            "queue_critical": int(os.environ.get("DEG_QUEUE_CRITICAL", "10000")),
            "queue_safe": int(os.environ.get("DEG_QUEUE_SAFE", "5000")),
            "queue_degraded": int(os.environ.get("DEG_QUEUE_DEGRADED", "1000")),
            "error_critical": float(os.environ.get("DEG_ERROR_CRITICAL", "0.5")),
            "error_safe": float(os.environ.get("DEG_ERROR_SAFE", "0.2")),
            "latency_critical": int(os.environ.get("DEG_LATENCY_CRITICAL", "5000")),
            "latency_safe": int(os.environ.get("DEG_LATENCY_SAFE", "2000")),
        }
