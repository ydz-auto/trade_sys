...
用法：
    from services.research_service.lstm_strategy import LSTMStrategy, LSTMConfig
...
class LSTMStrategy:
    ...
    async def train(
        ...
        from infrastructure.progress import ProgressTracker, ProgressType, ProgressBar, get_progress_tracker
