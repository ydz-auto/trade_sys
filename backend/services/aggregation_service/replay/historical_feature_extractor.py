...
from services.aggregation_service.models.candle_model import Candle, Timeframe, CandleWindow
from services.aggregation_service.models.trade_model import Trade, TradeBatch
...
class HistoricalFeatureExtractor:
    ...
    def _aggregate_to_1s_candles(self, trades: List[Trade]) -> List[Candle]:
        ...
        remaining_candles = aggregator.close_all()
        candles.extend(remaining_candles)
