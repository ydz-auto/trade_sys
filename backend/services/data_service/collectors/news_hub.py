"""
News Hub - 新闻综合采集中心
整合所有新闻源：RSS、API、Webhook、Twitter、LLM 爬虫
"""
import asyncio
import hashlib
...
from .news_feed_collector import RSSFeedCollector, NewsArticle
from .news_api_collector import NewsAPICollector
from .twitter_collector import TwitterCollector, TwitterPost, AlertPriority

logger = get_logger("collectors.news_hub")
