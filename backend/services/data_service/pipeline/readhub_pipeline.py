...
from services.data_service.utils import (
    get_http_client,
    RSSFetcher,
    RSSSource,
...
from services.data_service.quality import (
    get_deduplicator,
    get_scorer,
    get_tracker,
    get_reviewer,
...
from services.data_service.pipeline import (
    get_scheduler,
    get_pusher,
    TaskPriority
)
...
class ReadHubPipeline:
    ...
    def _init_default_sources(self):
        """初始化默认 RSS 源"""
        from services.data_service.utils import PRESET_RSS_SOURCES
